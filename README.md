...
After exporting the STEP model of the combined PCB, I split it into two separate boards and imported them into the cannon's 3D model to refine its mechanical design. (**TODO: REPLACE IMG**)
